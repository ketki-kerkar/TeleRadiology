  ...
  return (
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
               ...
               <Box color="black"
                ...
                <p> <ChevronRightIcon /> Doctor Name: {userData && userData.doctors && userData.doctors.length > 0 ? userData.doctors[0].dname: 'N/A'}</p>
            <p><ChevronRightIcon />  Doctor Type: {userData && userData.doctors && userData.doctors.length > 0 ? userData.doctors[0].dtype : 'N/A'}</p>
            <p><ChevronRightIcon /> Qualification: {userData && userData.doctors && userData.doctors.length > 0 ? userData.doctors[0].qualification : 'N/A'}</p>
            <p><ChevronRightIcon /> Hospital Name: {userData && userData.doctors && userData.doctors.length > 0 ? userData.doctors[0].hospitalName : 'N/A'}</p>
            <p><ChevronRightIcon /> Department: {userData && userData.doctors && userData.doctors.length > 0 ? userData.doctors[0].department : 'N/A'}</p>
